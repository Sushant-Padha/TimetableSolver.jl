...
VARDATA_divvarval_maps = OrderedDict(
    :subject =>
        OrderedDict(1 => ([1, 2, 3, 4, 5], [1, 2, 3]), 2 => ([6, 7, 8, 9, 10], [1, 2, 4])),
    :teacher => OrderedDict(
...
VARDATA_inversevarmap = OrderedDict(
    "9-C_1_1_subject" => 1,
    "9-C_1_2_subject" => 2,
    "9-C_1_3_subject" => 3,
    "9-C_2_1_subject" => 4,
...
VARDATA_inversevalmap = OrderedDict(
    "MATH" => 1,
    "ENG" => 2,
    "SPORTS" => 3,
    "SCIENCE" => 4,
